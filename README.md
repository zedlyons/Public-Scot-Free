...
* NIBRS-data
  ...
  * scotfreetandomforestmodel.joblib is the saved trained model (it is larger than github's file size limit so it has been left out of the repo. It is produced by ex_analysis.ipyn )
...
* web_app contains flask and HTML templates needed for running the web app. To function properly, copies of NIBRS-data/agencies.parquet and NIBRS-data/scotfreetandomforestmodel.joblib need to be moved to web_app/agencies.parquet and web_app/scotfreetandomforestmodel.joblib