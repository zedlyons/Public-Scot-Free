...
ALTER TABLE nibrs_arrestee_groupb DISABLE TRIGGER ALL;
ALTER TABLE nibrs_arrestee_groupb_weapon DISABLE TRIGGER ALL;
...
\COPY NIBRS_ARRESTEE_WEAPON FROM 'NIBRS_ARRESTEE_GROUPB_WEAPON.csv' DELIMITER ',' HEADER CSV;
...
\COPY NIBRS_ARRESTEE FROM 'NIBRS_ARRESTEE_GROUPB.csv' DELIMITER ',' HEADER CSV;
...
ALTER TABLE nibrs_arrestee_groupb ENABLE TRIGGER ALL;
ALTER TABLE nibrs_arrestee_groupb_weapon ENABLE TRIGGER ALL;
