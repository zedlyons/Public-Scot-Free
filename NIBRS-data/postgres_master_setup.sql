-- Originally this file was the the postgres_setup.sql found in the AK-2024 dataset. 
-- It has been modified to be generally applicable to NIBRS data from all states/years
...
arrestee_seq_num character varying(10),
...
/* Not statistically relevant, inconsistencies in the dataset make loading it more trouble than worth
...
/*
CREATE TABLE nibrs_arrestee_groupb (
data_year int,
groupb_arrestee_id bigint NOT NULL,
...
CREATE TABLE nibrs_arrestee_groupb_weapon (
data_year int,
groupb_arrestee_id bigint NOT NULL,
weapon_code character varying(3) NOT NULL,
weapon_id smallint NOT NULL
);
*/
...
/*Key constraints commented out because they cause more problems than they solve
...
--PKS
  ...
  ALTER TABLE ONLY PUBLIC.NIBRS_ARRESTEE_GB ADD CONSTRAINT NIBRS_ARRESTEE_GB_OFFENSE_TYPE_FK FOREIGN KEY (offense_code)
	  REFERENCES PUBLIC.NIBRS_OFFENSE_TYPE (offense_code);
